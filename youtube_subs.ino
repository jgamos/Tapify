...
#define API_KEY    "xxxxx"  // your google apps API key for Youtube Data API access
#define CHANNEL_ID "xxxxx"  // your Youtube channel ID
...
void pollYoutubeAPI() {
  if (api.getChannelStatistics(CHANNEL_ID)) {
    ...
    display.setTextColor(WHITE);
    display.setCursor(0, 0);
    display.println("Jezner - YouTube");
    display.println("");
    display.println("Subscibers");
    display.setTextSize(2);
